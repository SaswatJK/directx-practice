...
cl /std:c++17 -Zi -D_AMD64_ -I"..\include" -Fd"myapp.pdb" -Fo"main.obj" -Fe"main.exe" "%SOURCE_DIR%\main.cpp" /link /LIBPATH:"..\lib" SDL3.lib d3d12.lib dxgi.lib d3dcompiler.lib 
